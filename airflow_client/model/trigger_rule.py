...
class TriggerRule(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Trigger rule.., must be one of ["all_success", "all_failed", "all_done", "one_success", "one_failed", "none_failed", "none_skipped", "none_failed_or_skipped", "dummy", ]  # noqa: E501

        Keyword Args:
            value (str): Trigger rule.., must be one of ["all_success", "all_failed", "all_done", "one_success", "one_failed", "none_failed", "none_skipped", "none_failed_or_skipped", "dummy", ]  # noqa: E501
