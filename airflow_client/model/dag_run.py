...
class DAGRun(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, dag_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            start_date (datetime): The start time. The time when DAG run was actually created. . [optional]  # noqa: E501
