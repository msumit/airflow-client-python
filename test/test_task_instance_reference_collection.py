...
import airflow
from airflow.models.task_instance_reference_collection import TaskInstanceReferenceCollection  # noqa: E501
...
class TestTaskInstanceReferenceCollection(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = airflow.models.task_instance_reference_collection.TaskInstanceReferenceCollection()  # noqa: E501
        if include_optional :
            return TaskInstanceReferenceCollection(
                task_instances = [
                    airflow.models.task_instance_reference.TaskInstanceReference(
                        task_id = '0', 
                        dag_id = '0', 
                        execution_date = '0', 
                        dag_run_id = '0', )
