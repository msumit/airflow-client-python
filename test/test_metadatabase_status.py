...
import airflow
from airflow.models.metadatabase_status import MetadatabaseStatus  # noqa: E501
from airflow.rest import ApiException

class TestMetadatabaseStatus(unittest.TestCase):
    """MetadatabaseStatus unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test MetadatabaseStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = airflow.models.metadatabase_status.MetadatabaseStatus()  # noqa: E501
        if include_optional :
            return MetadatabaseStatus(
                status = 'healthy'
            )
        else :
            return MetadatabaseStatus(
    ...
    def testMetadatabaseStatus(self):
        """Test MetadatabaseStatus"""
