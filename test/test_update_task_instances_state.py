...
import airflow
from airflow.models.update_task_instances_state import UpdateTaskInstancesState  # noqa: E501
...
class TestUpdateTaskInstancesState(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = airflow.models.update_task_instances_state.UpdateTaskInstancesState()  # noqa: E501
        if include_optional :
            return UpdateTaskInstancesState(
                dry_run = True, 
                task_id = '0', 
                execution_date = '0', 
