...
class MetadatabaseStatus(object):
    ...
    def __init__(self, status=None, local_vars_configuration=None):  # noqa: E501
        """MetadatabaseStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def status(self):
        """Gets the status of this MetadatabaseStatus.  # noqa: E501


        :return: The status of this MetadatabaseStatus.  # noqa: E501
        :rtype: HealthStatus
        """
        return self._status
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MetadatabaseStatus):
            return False
