...
class TaskCollection(object):
    ...
    def __init__(self, tasks=None, local_vars_configuration=None):  # noqa: E501
        """TaskCollection - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def tasks(self):
        """Gets the tasks of this TaskCollection.  # noqa: E501


        :return: The tasks of this TaskCollection.  # noqa: E501
        :rtype: list[Task]
        """
        return self._tasks
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskCollection):
            return False
