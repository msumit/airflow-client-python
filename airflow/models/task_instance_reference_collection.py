...
class TaskInstanceReferenceCollection(object):
    ...
    def task_instances(self):
        """Gets the task_instances of this TaskInstanceReferenceCollection.  # noqa: E501


        :return: The task_instances of this TaskInstanceReferenceCollection.  # noqa: E501
    ...
    def task_instances(self, task_instances):
        ...
        :type: list[TaskInstanceReference]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TaskInstanceReferenceCollection):
            return False
